    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                ...
                Text(
                    "Comparte tu opinión sobre el evento. Tu valoración nos ayuda a mejorar futuras ediciones.",
            ...
            item {
                ...
                Spacer(modifier = Modifier.height(4.dp))
                Text(
                    "Valora individualmente cada ponencia. Puedes dejar sin puntuar a las que no hayas asistido.",
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
            }
